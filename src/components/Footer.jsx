...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col md:flex-row items-center justify-between py-4 px-4 md:px-8 border-t border-neutral-800 bg-transparent">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-4 md:mt-0 text-xl">
